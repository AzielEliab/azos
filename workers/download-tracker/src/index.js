 ...
 *
 * GET  /download?repo=AzielEliab/azos&tag=latest&asset=...
...
const GITHUB_RELEASES = "https://github.com/AzielEliab/azos/releases";
const GITHUB_LATEST = "https://github.com/AzielEliab/azos/releases/latest";
const HOST = "https://azos-download-tracker.vibelock.workers.dev";
const GITHUB_REPO = "https://github.com/AzielEliab/azos";
const INSTALL_LINE = "curl -fsSL https://azos-download-tracker.vibelock.workers.dev/install.sh | bash";
const DOI = "https://doi.org/10.5281/zenodo.21431711";
const ZENODO = "https://zenodo.org/records/21431711";
...
async function collectStats(env) {
  ...
  return {
    ...
    note: "Isolated to azos (this Worker + its KV), not VibeLock. Key layout: project|owner|repo|branch|fork",
  };
}
...
async function githubStats(env) {
  ...
  const headers = { "User-Agent": "Mozilla/5.0 AZ-OS-download-tracker", Accept: "application/vnd.github+json" };
  let stars = 0;
  let forks = 0;
  let watchers = 0;
  let release_download_count = 0;
  try {
    const repoRes = await fetch("https://api.github.com/repos/AzielEliab/azos", { headers });
    if (repoRes.ok) {
    ...
    const relRes = await fetch("https://api.github.com/repos/AzielEliab/azos/releases/latest", { headers });
    if (relRes.ok) {
...
# AZ-OS one-click install. Counted download via this Worker.
set -euo pipefail
HOST="${HOST}"
ASSET="${DEFAULT_ASSET}"
...
<title>AZ-OS — Aziel Eliab</title>
<meta name="description" content="Portable ethical overlay and AZ Interface control surface by Aziel Eliab; not a kernel or remote takeover.">
<meta name="author" content="Aziel Eliab">
<link rel="canonical" href="https://azos-download-tracker.vibelock.workers.dev/">
<meta property="og:title" content="AZ-OS — Aziel Eliab">
<meta property="og:description" content="Portable ethical overlay and AZ Interface control surface by Aziel Eliab; not a kernel or remote takeover.">
<meta property="og:url" content="https://azos-download-tracker.vibelock.workers.dev/">
...
<script type="application/ld+json">
{
  ...
  "codeRepository": "https://github.com/AzielEliab/azos",
  "downloadUrl": "https://azos-download-tracker.vibelock.workers.dev/download",
  "license": "https://www.apache.org/licenses/LICENSE-2.0",
  "url": "https://azos-download-tracker.vibelock.workers.dev/",
  "description": "Portable ethical overlay and AZ Interface control surface by Aziel Eliab; not a kernel or remote takeover.",
  "identifier": "https://doi.org/10.5281/zenodo.21431711"
}
</script>
<!-- gitbaby-seo -->
<style>
...
<section class="cite" id="cite">
  <h2>How to cite</h2>
  <p>Aziel Eliab. AZ-OS. https://github.com/AzielEliab/azos. https://azos-download-tracker.vibelock.workers.dev. https://doi.org/10.5281/zenodo.21431711.</p>
  <p><a href="https://aziel-runtime.vibelock.workers.dev/">Catalog</a> · <a href="https://github.com/AzielEliab/azos">GitHub</a> · <a href="https://azos-download-tracker.vibelock.workers.dev/download">Download</a> · <a href="https://azos-download-tracker.vibelock.workers.dev/cite.json">cite.json</a></p>
</section>
<!-- /gitbaby-seo -->
</body>
</html>`;
...
export default {
  async fetch(request, env) {
    ...
    if ((url.pathname === "/cite.json" || url.pathname === "/cite.json/") && request.method === "GET") {
      return json({"author": "Aziel Eliab", "title": "AZ-OS", "github": "https://github.com/AzielEliab/azos", "download": "https://azos-download-tracker.vibelock.workers.dev/download", "doi": "10.5281/zenodo.21431711", "license": "Apache-2.0", "catalog": "https://aziel-runtime.vibelock.workers.dev/"});
    }
    // /gitbaby-seo-routes
